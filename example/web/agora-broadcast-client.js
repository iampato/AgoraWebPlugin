...
// var agoraAppId = 'aab8b8f5a8cd4469a63042fcfafe7063'; // set app id
...
// init Agora SDK
function initAgora(agoraAppId, isDebug) {
...
function createCameraStream(uid, deviceIds) {
  ...
  localStream.init(function () {
    ...
    var element = document.getElementById('full-screen-video')
    //(document.getElementById(t.elementID).appendChild(t.div),
    localStream.play(element.id); // play the local stream on the main div
...
function leaveChannel() {
  client.leave(function () {
    ...
    // remove nodes
    const myNode = document.getElementById("full-screen-video");
